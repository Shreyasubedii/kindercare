...
import 'package:kindercaremvvm/ui/views/dashboard/dashboard_view.dart' as _i15;
...
import 'package:kindercaremvvm/ui/views/homepage/homepage_view.dart' as _i16;
...
import 'package:kindercaremvvm/ui/views/meal_track/meal_track_view.dart'
    as _i11;
import 'package:kindercaremvvm/ui/views/messages/messages_view.dart' as _i18;
...
class StackedRouter extends _i1.RouterBase {
  final _routes = <_i1.RouteDef>[
    ...
    _i1.RouteDef(
      Routes.homepageView,
      page: _i16.HomepageView,
    ),
    _i1.RouteDef(
      Routes.teacherProfileView,
      page: _i17.TeacherProfileView,
    ),
    _i1.RouteDef(
      Routes.messagesView,
      page: _i18.MessagesView,
    ),
  ];
  ...
  final _pagesMap = <Type, _i1.StackedRouteFactory>{
    ...
    _i16.HomepageView: (data) {
      return _i19.MaterialPageRoute<dynamic>(
        builder: (context) => const _i16.HomepageView(),
        settings: data,
      );
    },
    _i17.TeacherProfileView: (data) {
      return _i19.MaterialPageRoute<dynamic>(
        builder: (context) => const _i17.TeacherProfileView(),
        settings: data,
      );
    },
    _i18.MessagesView: (data) {
      return _i19.MaterialPageRoute<dynamic>(
        builder: (context) => const _i18.MessagesView(),
        settings: data,
      );
    },
  };
